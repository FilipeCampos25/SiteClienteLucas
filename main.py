...
def produtos(
    ...
    produtos = (
        base_query
        .order_by(
            models.Produto.destaque_home.desc(),
...
def admin_produto_novo(
    ...
    nome: str = Form(...),
    descricao: str = Form(""),
    catalogo_url: str = Form(""),
    resumo_curto: str = Form(""),
    ordem_exibicao: int = Form(0),
    destaque_home: bool = Form(False),
    valor: float = Form(...),
...
def admin_produto_atualizar(
    ...
    catalogo_url: str = Form(None),
    resumo_curto: str = Form(None),
    ordem_exibicao: int = Form(None),
    destaque_home: Optional[bool] = Form(None),
